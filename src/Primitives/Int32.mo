...
module {
  ...
  public func tag() : Tag { Tag.int32 };

  public func valid( s : Struct ) : Bool {
    if ( Struct.Tag.notEqual(s, Tag.int32) ) false
  ...
  public func toStruct( int32 : Int32 ) : Struct {
    ...
    Struct.build(?Tag.int32, ?5, ?#array( value ))
  };

  public func fromStruct( s : Struct ) : ?Int32 {
    if ( Struct.Tag.notEqual(s, Tag.int32) ) return null;
